angular.module('myApp.topicController', ['ngRoute'])
    ...
    .controller('topicController', function ($scope, $mdDialog, $http, $location, $rootScope, Auth, $mdSidenav, topicParams, $localStorage) {
        ...
        $scope.getTopicUsers = function (idTopic) {
            $http.get('https://api.bschat.guillaumeperes.fr/api/topic/' + idTopic + '/users')
        ...
        $scope.isTopicMember = function () {
            ...
            $http.post('https://api.bschat.guillaumeperes.fr/api/topic/userMember', formData).then(function (response) {
                if(response.data == 0) {
        ...
        $scope.getTopicMessages = function (idTopic) {
            $http.get('https://api.bschat.guillaumeperes.fr/api/topic/' + idTopic + '/posts').then(function (response) {
        ...
        $scope.addMessage = function () {
            ...
            $http.post('https://api.bschat.guillaumeperes.fr/api/topic/sendMessage', data).then(function (response) {
        ...
        $scope.leaveTopic = function () {
            $http.get('https://api.bschat.guillaumeperes.fr/api/user/' + $scope.user.id + '/topic/' + $scope.topic.id + '/leave').then(function (response) {
                window.location = 'https://bschat.guillaumeperes.fr/#/home';
            });
        };
        ...
        $scope.deleteTopic = function () {
            ...
            $http.post('https://api.bschat.guillaumeperes.fr/api/topic/delete',data).then(function (response) {
                window.location = 'https://bschat.guillaumeperes.fr/#/home';
            });
        };
        ...
        $scope.deleteUserFromTopic = function (idUser) {
            ...
            $http.post('https://api.bschat.guillaumeperes.fr/api/topic/user/delete',data).then(function (response) {
        ...
        $scope.addTopicUser = function (contact) {
            ...
            $http.post('https://api.bschat.guillaumeperes.fr/api/topic/addContact', formData)
                .then(function (response) {
                    if(response.data != 'denied'){
        ...
        $scope.openModifyTopicNameModal = function (ev) {
            ...
            function modifyTopicNameModalController($scope, $mdDialog, $location,Auth) {
                ...
                $scope.modifyTopicName = function () {
                    ...
                    $http.post('https://api.bschat.guillaumeperes.fr/api/topic/modify', formData)
                        .then(function (response) {
                            window.location = 'https://bschat.guillaumeperes.fr/#/home';
                            $mdDialog.hide();
                        })
